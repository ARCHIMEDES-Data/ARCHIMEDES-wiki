...
![french banner](images/frenchbanner.png)

## À qui s'adresse ce guide? 📘

Ce guide s'adresse aux utilisateurs qui commencent à utiliser [ARCHIMEDES](https://www.archimedesdata.ca/fr/home-fr/). Il fournit des instructions étape par étape sur la création d'un compte, l'accès aux données, le transfert de données, la diffusion des données, ainsi que sur la recherche et l'analyse des données au sein de la plateforme.

Pour plus d'informations, consultez la [FAQ](https://www.archimedesdata.ca/fr/questions-frequemment-posees/) ou la [Gouvernance des données](https://www.archimedesdata.ca/wp-content/uploads/2026/05/ARCHIMEDES-Data-Governance-Framework-V1-January-2026.pdf).
...
➡️ [ARCHIMEDES](https://www.archimedesdata.ca//fr/home-fr/) réunit **tout** au sein d'une plateforme sécurisée — données, gouvernance et outils d'analyse — afin de permettre aux chercheurs de travailler plus efficacement et de façon collaborative.
...
Avec [ARCHIMEDES](https://www.archimedesdata.ca//fr/home-fr/), vous pouvez :
...
[ARCHIMEDES](https://www.archimedesdata.ca//fr/home-fr/) héberge des données de santé multimodales sélectionnées, notamment des données de recherche, des données comportementales, des données d’imagerie, des données sur les biomatériaux et des données administratives. Cela comprend à la fois les données provenant de participants à des recherches humaines et les données ne provenant pas de participants à des recherches humaines (c’est-à-dire les données précliniques).

## Comment accéder aux données? 🔐

[ARCHIMEDES](https://www.archimedesdata.ca//fr/home-fr/) utilise un système d'accès flexible qui permet aux contributeurs de données de déterminer comment leurs ensembles de données sont partagés et accessibles.
...
![Flux de données ARCHIMEDES](images/Data_Flow_july2026.jpg)

[Commencer](getting-started.md){ .md-button .md-button--primary }